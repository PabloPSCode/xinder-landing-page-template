...
export default function InfoLinkCard({ url, title, text }: InfoLinkCardProps) {
  ...
  return (
    ...
    >
      <div className="flex-1">
        <h3 className="text-md sm:text-lg font-semibold text-foreground break-words">
          {title}
        </h3>
        <p className="text-xs sm:text-sm text-muted-foreground text-foreground">
          {text}
        </p>
      </div>
